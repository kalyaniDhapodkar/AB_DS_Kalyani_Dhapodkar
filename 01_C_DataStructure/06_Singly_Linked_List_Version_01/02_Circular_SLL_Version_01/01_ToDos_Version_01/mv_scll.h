...
#ifndef _MV_SINGLY_CIRCULAR_LIST_H
#define _MV_SINGLY_CIRCULAR_LIST_H
...
typedef struct mv_singly_circular_list mv_singly_circular_list_t;
typedef struct mv_singly_circular_list *p_mv_singly_circular_list_t;
typedef struct mv_singly_circular_list **pp_mv_singly_circular_list_t;

typedef mv_singly_circular_list_t mv_scll_t;
typedef p_mv_singly_circular_list_t p_mv_scll_t;
typedef pp_mv_singly_circular_list_t pp_mv_scll_t;
...
struct mv_singly_circular_list
{
...
#define SIZE_LIST (sizeof(mv_singly_circular_list_t))
...
#endif /* _MV_SINGLY_CIRCULAR_LIST_H */
