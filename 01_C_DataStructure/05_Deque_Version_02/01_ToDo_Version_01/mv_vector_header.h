...
extern  p_mv_vector_t  mv_create_default_vector(size_t);
extern  p_mv_vector_t  mv_create_custom_vector(size_t);
...
extern ret_t mv_vector_print_data(p_mv_vector_t, PRINTDATAPROC);
extern  	ret_t  	mv_vector_destroy(pp_mv_vector_t, DELETEDATAPROC);
