...
struct mv_doubly_list;

typedef struct mv_doubly_list		mv_doubly_list_t;
typedef	struct mv_doubly_list*		p_mv_doubly_list_t;
typedef	struct mv_doubly_list**	pp_mv_doubly_list_t;

typedef	mv_doubly_list_t	mv_dll_t;
typedef	p_mv_doubly_list_t	p_mv_dll_t;
typedef	pp_mv_doubly_list_t	pp_mv_dll_t;
...
#define	SIZE_DLL	(sizeof(mv_dll_t))
